...
- (id)init {
    ...
    if(self) {
         ...
         */
        self.playerView = [[[AVFoundationVideoPlayerView alloc] initWithFrame:[[[NSScreen screens] objectAtIndex:0] frame] autorelease];
//        self.playerView.backgroundColor = [CIColor blackColor];
